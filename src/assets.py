...
powerup_icons = {
    ...
    "strength": pygame.Surface((40, 40)),
    "clustershot": pygame.Surface((24, 24)),
}
powerup_icons["strength"].fill((255, 0, 0))
...
mist = load_img(f"{TEXTURES}/misc/mist.png", factor=1, alpha=True)
